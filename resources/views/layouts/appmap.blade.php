...
<head>
    ...
    <style>
        #map {
            width: 100%;
            height: 280px;
            background-color: #0893ce; /*#089aaa*/
          }
...
<body>
    ...
    <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyBNIpKzEJLzslyPPri29cUcgYUNXzeqZBk"></script>
    
    <script>
      
    mostrarCamino('{{$nombrehospedaje}}', '{{$direccionhospedaje}}');
    ...
    function mostrarCamino(nombreHospedaje, direccion)
    {
        ...
        if (status == google.maps.GeocoderStatus.OK) {
            ...
            dibujar(latitude, longitude, direccion_hosp);
            }
        });

    }
      
    function dibujar(latitudHospedaje, longitudHospedaje, direccionHospedaje)
    {   
	    ...
	    if(direccionHospedaje != "")
	    {
            ...
            var puntoMark2= new google.maps.LatLng(-31.415271, -62.094163); 
            bounds.extend(puntoMark2);
	    }
      ...
      //mostrarInicialmente('{{$nombrehospedaje}}');
                            
    function mostrarInicialmente(nombreHospedaje)
    {
