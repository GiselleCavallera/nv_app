...
@section('content')
 ...
 <link rel="stylesheet" href="{{ asset('css/style_car.css') }}">
    ...
    <section id="carouselContainer" class="trans3d">
        @foreach($inscriptos_sorteo as $inscripto)
            <figure id="item1" class="carouselItem trans3d"><div class="carouselItemInner trans3d" style="font-size: 30px">{{$inscripto->nombre}}</div></figure>                    
        @endforeach
    </section>
    </div>
